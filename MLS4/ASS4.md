...
This criterion is linked to a Learning OutcomeStructured and Unstructured Pruning
25 to >23.0 pts
Excellent
- Complete implementation of both magnitude-based and structured pruning with proper fine-tuning - Thorough analysis of sparsity patterns across different layer types - Comprehensive comparison of gradual vs one-shot pruning with convergence analysis - Clear documentation of pruning impact on model architecture and performance
23 to >20.0 pts
Good
- Working implementation of both pruning types with adequate fine-tuning - Good analysis of sparsity patterns with some layer-specific insights - Basic comparison of gradual vs one-shot approaches - Reasonable documentation of results
20 to >16.0 pts
Satisfactory
- Basic implementation of at least one pruning type - Limited analysis of sparsity patterns - Incomplete comparison between pruning approaches - Minimal documentation
16 to >8.0 pts
Needs Improvement
- Incomplete or non-functional pruning implementations - No meaningful analysis of sparsity patterns - Missing comparison between approaches - Poor or missing documentation
8 to >0 pts
No Marks
Missing or completely non-functional submission
25 pts
This criterion is linked to a Learning OutcomeAdvanced Quantization Techniques
25 to >23.0 pts
Excellent
- Complete implementation of mixed-bit quantization with layer sensitivity analysis - Thorough comparison of PTQ vs QAT with convergence analysis - Working implementation of extreme quantization (INT4/binary) with detailed analysis - Clear understanding of quantization trade-offs and limitations
23 to >20.0 pts
Good
- Working mixed-bit quantization with basic sensitivity analysis - Good comparison of PTQ vs QAT approaches - Attempted extreme quantization with some analysis - Good understanding of quantization concepts
20 to >16.0 pts
Satisfactory
- Basic quantization implementation - Limited comparison between approaches - Minimal extreme quantization exploration - Basic understanding demonstrated
16 to >8.0 pts
Needs Improvement
- Incomplete quantization implementations - No meaningful comparison between approaches - Missing extreme quantization - Poor understanding of concepts
8 to >0 pts
No Marks
Missing or completely non-functional submission
25 pts
This criterion is linked to a Learning OutcomeKnowledge Distillation Optimization
25 to >23.0 pts
Excellent
- Systematic temperature optimization with comprehensive analysis - Working progressive distillation with multiple intermediate models - Implementation of attention transfer with comparative analysis - Deep understanding of knowledge transfer mechanisms
23 to >20.0 pts
Good
- Good temperature optimization with basic analysis - Basic progressive distillation implementation - Attempted attention transfer with some analysis - Good understanding of distillation concepts
20 to >16.0 pts
Satisfactory
- Basic knowledge distillation implementation - Limited temperature optimization - Minimal progressive or attention-based approaches - Basic understanding demonstrated
16 to >8.0 pts
Needs Improvement
- Incomplete distillation implementations - No systematic optimization - Missing advanced distillation techniques - Poor understanding of concepts
8 to >0 pts
No Marks
Missing or completely non-functional submission
25 pts
This criterion is linked to a Learning OutcomeCompression Technique Interaction Analysis
25 to >23.0 pts
Excellent
- Comprehensive analysis of all compression technique combinations - Systematic evaluation across multiple metrics and scenarios - Clear guidelines for technique selection with practical recommendations - Novel insights into technique interactions and trade-offs
23 to >20.0 pts
Good
- Good analysis of major compression combinations - Evaluation across key metrics - Reasonable guidelines for technique selection - Some useful insights into interactions
20 to >16.0 pts
Satisfactory
- Basic analysis of some compression combinations - Limited evaluation metrics - Minimal guidelines provided - Few insights demonstrated
16 to >8.0 pts
Needs Improvement
- Incomplete or superficial analysis - No systematic evaluation - Missing or poor guidelines - No meaningful insights
8 to >0 pts
No Marks
Missing or completely non-functional submission
25 pts
